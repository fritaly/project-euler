...
public class Problem83 {
	...
	public static void main(String[] args) {
		final Scanner scanner = new Scanner(Problem83.class.getResourceAsStream("p083_matrix.txt"));
		...
		while (!queue.isEmpty()) {
			...
			if ((cell.x == 0) && (cell.y == 0)) {
				...
				final long right = (cell.x < size - 1) ? table[cell.y][cell.x + 1] : Long.MAX_VALUE;
				...
				final long min = Utils.min(left, right, top, bottom) + matrix[cell.y][cell.x];
